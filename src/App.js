    ...
    <>
      <header className="row mt-5 justify-content-center">
        <ul className="d-flex">
          <img
            className="logo"
            src="https://hidoc.co/assets/img/logo/logo-desktop.png"
          />
          ...
          <div className="my-4">
            ...
            <div className="moreOptions d-flex row align-items-center">
              ...
              <div className="col-sm-4 p-2 latest">
                <div className="moreOndoc1 mb-2 d-flex align-items-center">
                  <svg
                ...
                <div className="moreOndoc1 my-3 d-flex">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="25"
                    height="25"
                    fill="white"
                    class="bi bi-journal-check font"
                    viewBox="0 0 16 16"
                  >
                    <path
                      fill-rule="evenodd"
                  ...
                  <h5>Surveys: </h5>
                  <span>Participate in Surveys to earn extra points</span>
                </div>
                <div className="moreOndoc1 nostyle d-flex">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="25"
                    height="25"
                    fill="white"
                    class="bi bi-calculator font"
                    className="font"
                    viewBox="0 0 16 16"
                  >
                  ...
                  <span>Tagline calculator</span>
                </div>
              </div>
            </div>
          </div>
          <div className="d-flex visitWrapper">
            <h2>social newtwork for doctors-A special feature on hidoc</h2>
            <button className="btn btn-primary visitButton">Visit</button>
          </div>
        </div>
      </body>
      <footer className="bodyContainer row p-4">
        ...
        <div className="col-sm-3 p-3">
          ...
          <p>varun@hidoc.co</p>
          <p>Address:</p>
          <p>Hidoc Dr.inc,2055 Limestone Rd,STE 200-C,</p>
          <p>Wilmington,DE,19808,United States.</p>
        </div>
